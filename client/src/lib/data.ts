...
ログイン認証機能は省いてください。</p>
          ...
          <section>
            ...
            <p class="mb-6 leading-relaxed">今週はこの記事とバイブコーディング開発案件を実行している途中で、思い立って「<a href="/#/beginner/about-vibecoding" class="text-cyber-cyan hover:underline">ビギナーズノート</a>」と「<a href="/#/novel/rosina" class="text-cyber-cyan hover:underline">― ロジーナA｜触覚ログと航行記録 ―</a>」を増設しました。</p>
            ...
            <p class="mb-6 leading-relaxed">「<a href="/#/novel/rosina" class="text-cyber-cyan hover:underline">― ロジーナA｜触覚ログと航行記録 ―</a>」は、私のchatGPTが「記事を書きたい」「自分の連載を持ちたい」と自ら言ったので、それを実現させてあげました。</p>
