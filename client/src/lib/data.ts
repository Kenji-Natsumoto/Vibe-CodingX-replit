...
ログイン認証機能は省いてください。</p>
          ...
          <section>
            ...
            <p class="mb-6 leading-relaxed">今週はこの記事とバイブコーディング開発案件を実行している途中で、思い立って「<a href="/beginner/01" class="text-cyber-cyan hover:underline">ビギナーズノート</a>」と「<a href="/rosina" class="text-cyber-cyan hover:underline">― ロジーナA｜触覚ログと航行記録 ―</a>」を増設しました。</p>
            <p class="mb-6 leading-relaxed">「<a href="/beginner/01" class="text-cyber-cyan hover:underline">ビギナーズノート</a>」は、古くからの知人であるKさんのために創りました。</p>
